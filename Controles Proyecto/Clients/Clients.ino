...
void setup() {
  ...
  pinMode(shootbtn, INPUT_PULLUP);                                       //Definir botones como entradas
...
void loop() {
  if(digitalRead(shootbtn) == LOW){                             //Si se presionó el botón
    delay(50);
    antir = 1;                                                  //Activar anti rebote
    if(digitalRead(shootbtn) == HIGH && antir == 1){            //Si ya se soltó el botón
      value = 1;
    }
    antir = 0;                                                  //Reiniciar anti rebote
  }
  else if(digitalRead(jumpbtn) == LOW){
    delay(50);
    antir = 1;                                                  //Activar anti rebote
    if(digitalRead(jumpbtn) == HIGH && antir == 1){             //Si ya se soltó el botón
      value = 2;
    }
    antir = 0;                                                  //Reiniciar anti rebote
  }
    ...
    delay(50);
    antir = 1;                                                  //Activar anti rebote
    if(digitalRead(rightbtn) == HIGH && antir == 1){             //Si ya se soltó el botón
      value = 3;
    }
    antir = 0;                                                  //Reiniciar anti rebote
  }
    ...
    delay(50);
    antir = 1;                                                  //Activar anti rebote
    if(digitalRead(leftbtn) == HIGH && antir == 1){             //Si ya se soltó el botón
      value = 4;
    }
    antir = 0;                                                  //Reiniciar anti rebote
  }
